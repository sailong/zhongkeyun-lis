 ...
 * @since 1.1
 */
class DeleteColumn extends CGridColumn
{
	/**
	...
	public $deleteClass = 'bu_sc';
	
	
	public function init()
	{
		$this->htmlOptions['class'] = '';
		$this->linkHtmlOptions = array('class'=>$this->deleteClass);
		$this->header = '操作';
		$this->label = '';
		$this->urlExpression = 'Yii::app()->controller->createUrl("delete",array("id"=>$data->primaryKey))';
	...
	{
		$script = <<<EOF
jQuery(document).on('click','#{$this->grid->id} a.{$this->deleteClass}',function(){
